...
checkfun <- function(res, tau) {
    .Call(`_fqr_checkfun`, res, tau)
}

parallelVectorCheckFun <- function(x, tau) {
    .Call(`_fqr_parallelVectorCheckFun`, x, tau)
}

reorder_columns <- function(X, intercept) {
    invisible(.Call(`_fqr_reorder_columns`, X, intercept))
}

fast_rexp <- function(n) {
    .Call(`_fqr_fast_rexp`, n)
}

update_huber_grad <- function(X_t, res, derivs, grad, tau, mu, n, one_over_n) {
    invisible(.Call(`_fqr_update_huber_grad`, X_t, res, derivs, grad, tau, mu, n, one_over_n))
}

z_score <- function(X, mx, sx, p) {
    invisible(.Call(`_fqr_z_score`, X, mx, sx, p))
}

huber_grad_descent <- function(y, X, X_t, beta, grad, derivs, tau, n, one_over_n, p, maxiter, mu, beta_tol, check_tol) {
    .Call(`_fqr_huber_grad_descent`, y, X, X_t, beta, grad, derivs, tau, n, one_over_n, p, maxiter, mu, beta_tol, check_tol)
}
...
#' @export
fit_approx_quantile_model <- function(X, y, X_sub, y_sub, tau, init_beta, mu = 1e-15, maxiter = 100000L, beta_tol = 1e-4, check_tol = 1e-6, intercept = 1L, num_samples = 1000, warm_start = 1L, scale = 1L, lambda = 0) {
    .Call(`_fqr_fit_approx_quantile_model`, X, y, X_sub, y_sub, tau, init_beta, mu, maxiter, beta_tol, check_tol, intercept, num_samples, warm_start, scale, lambda)
}
...
fit_penalize_approx_quantile_model <- function(X, y, X_sub, y_sub, tau, init_beta, mu = 1e-15, maxiter = 100000L, beta_tol = 1e-4, check_tol = 1e-6, intercept = 1L, num_samples = 1000, warm_start = 1L, scale = 1L) {
    .Call(`_fqr_fit_penalize_approx_quantile_model`, X, y, X_sub, y_sub, tau, init_beta, mu, maxiter, beta_tol, check_tol, intercept, num_samples, warm_start, scale)
}

update_huber_grad_sp <- function(X_t, res, derivs, grad, tau, mu, n, one_over_n) {
    invisible(.Call(`_fqr_update_huber_grad_sp`, X_t, res, derivs, grad, tau, mu, n, one_over_n))
}

huber_grad_descent_sp <- function(y, X, X_t, beta, tau, n, one_over_n, p, maxiter, mu, beta_tol, check_tol) {
    .Call(`_fqr_huber_grad_descent_sp`, y, X, X_t, beta, tau, n, one_over_n, p, maxiter, mu, beta_tol, check_tol)
}
...
fit_approx_quantile_model_sp <- function(X, y, X_sub, y_sub, tau, init_beta, mu = 1e-4, maxiter = 10000L, beta_tol = 1e-4, check_tol = 1e-6, intercept = 1L, num_samples = 1000, warm_start = 1L) {
    .Call(`_fqr_fit_approx_quantile_model_sp`, X, y, X_sub, y_sub, tau, init_beta, mu, maxiter, beta_tol, check_tol, intercept, num_samples, warm_start)
}
...
glob_obs_mat <- function(X, r, thresh) {
    .Call(`_fqr_glob_obs_mat`, X, r, thresh)
}
...
glob_obs_vec <- function(y, r, thresh) {
    .Call(`_fqr_glob_obs_vec`, y, r, thresh)
}

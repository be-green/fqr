...
gradient descent. While the quantile loss function isn't differentiable, you can get an arbitrarily close smooth approximation by replacing the "check" function with an appropriately tilted least squares approximation for a small neighborhood around the origin. As the size of that window goes to zero, you have your check function back!
